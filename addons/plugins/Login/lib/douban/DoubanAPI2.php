...
class DoubanAPI2 {
     ...
     * @return DoubanAPI2
     */
   	public function getFriends($uid, $accessToken, $page = 0, $count = 30) {
   		//shuo/v2/users/:id/followers
   		$this->uri = "/shuo/v2/users/{$uid}/followers?page={$page}&count={$count}";
   		$this->header = array(
   			'Authorization: Bearer ' . $accessToken
   			);
   	 ...
   	 * @param json $image 图片内容
   	 * @param json $attachments 内容描述
   	 */
   	public function newStutas($accessToken) {
